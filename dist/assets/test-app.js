            ...
            _ember["default"].$.ajax({
                ...
                success: function success(data) {
                    for (var i = 0; i < data.length; i++) {
                        if (data[i].ActivityCode === param.ActivityCode && data[i].IDNumber === "50154997" && data[i].SessionCode === param.SessionCode.trim()) {
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    var child0 = (function () {
      ...
      return {
        ...
        statements: [["block", "link-to", ["specific-activity", ["get", "membership.SessionCode", ["loc", [null, [11, 34], [11, 56]]]], ["get", "ActivityCode", ["loc", [null, [11, 57], [11, 69]]]], ["get", "membership.ActivityCode", ["loc", [null, [11, 70], [11, 93]]]]], [], 0, null, ["loc", [null, [11, 3], [15, 15]]]]],
        locals: ["membership"],
        templates: [child0]
      };
    })();
